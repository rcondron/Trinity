...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/Trinity/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/Trinity/extensions",
        global: "/Users/x/.Trinity/extensions",
        workspace: "/Users/x/ws/.Trinity/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.Trinity/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/Trinity/extensions",
        global: "/Users/x/.Trinity/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.Trinity/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/Trinity/extensions",
        global: "/Users/x/.Trinity/extensions",
