...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.Trinity.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", Trinity_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.Trinity.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.Trinity.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when Trinity_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.Trinity.gateway.plist",
    },
    {
      name: "uses profile-specific label when Trinity_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", Trinity_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.Trinity.jbphoenix.plist",
    },
    {
      name: "prefers Trinity_LAUNCHD_LABEL over Trinity_PROFILE",
      env: {
        HOME: "/Users/test",
        Trinity_PROFILE: "jbphoenix",
        Trinity_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from Trinity_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        Trinity_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty Trinity_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        Trinity_PROFILE: "myprofile",
        Trinity_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.Trinity.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
