...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.Trinity_STATE_DIR = "/tmp/Trinity-cli-state";
    process.env.Trinity_CONFIG_PATH = "/tmp/Trinity-cli-state/Trinity.json";
    delete process.env.Trinity_GATEWAY_PORT;
    delete process.env.Trinity_PROFILE;
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        Trinity_PROFILE: "dev",
        Trinity_STATE_DIR: "/tmp/Trinity-daemon-state",
        Trinity_CONFIG_PATH: "/tmp/Trinity-daemon-state/Trinity.json",
        Trinity_GATEWAY_PORT: "19001",
      },
