...
function resolveAnthropicDefaultAuthMode(cfg: TrinityConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: TrinityConfig): TrinityConfig {
...
export function applyTalkApiKey(config: TrinityConfig): TrinityConfig {
...
export function applyModelDefaults(cfg: TrinityConfig): TrinityConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: TrinityConfig): TrinityConfig {
...
export function applyLoggingDefaults(cfg: TrinityConfig): TrinityConfig {
...
export function applyContextPruningDefaults(cfg: TrinityConfig): TrinityConfig {
...
export function applyCompactionDefaults(cfg: TrinityConfig): TrinityConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
