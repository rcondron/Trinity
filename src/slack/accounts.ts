...
function mergeSlackAccountConfig(cfg: TrinityConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: TrinityConfig): ResolvedSlackAccount[] {
