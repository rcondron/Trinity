...
// Prefix for Trinity-generated action IDs to scope our handler
const Trinity_ACTION_PREFIX = "Trinity:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle Trinity modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${Trinity_ACTION_PREFIX}`),
