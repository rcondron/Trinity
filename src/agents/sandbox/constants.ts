...
export const DEFAULT_SANDBOX_IMAGE = "Trinity-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "Trinity-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "Trinity-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "Trinity-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "Trinity-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "Trinity-sandbox-browser";
