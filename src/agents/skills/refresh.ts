...
function resolveWatchPaths(workspaceDir: string, config?: TrinityConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: TrinityConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: TrinityConfig }) {
