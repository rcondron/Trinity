...
describe("buildSandboxCreateArgs", () => {
  function createSandboxConfig(
    ...
    return {
      image: "Trinity-sandbox:bookworm-slim",
      containerPrefix: "Trinity-sbx-",
      workdir: "/workspace",
      readOnlyRoot: false,
      tmpfs: [],
      network: "none",
  ...
  it("includes hardening and resource flags", () => {
    const cfg: SandboxDockerConfig = {
      ...
      apparmorProfile: "Trinity-sandbox",
      dns: ["1.1.1.1"],
      extraHosts: ["internal.service:10.0.0.5"],
    };

    const args = buildSandboxCreateArgs({
      name: "Trinity-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "Trinity.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "Trinity.sandbox=1",
        "--label",
        "Trinity.sessionKey=main",
        "--label",
        "Trinity.createdAtMs=1700000000000",
        "--label",
