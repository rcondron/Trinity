...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveTrinityAgentDir() returns mainAgentDir
    process.env.Trinity_STATE_DIR = tmpDir;
    process.env.Trinity_AGENT_DIR = mainAgentDir;
