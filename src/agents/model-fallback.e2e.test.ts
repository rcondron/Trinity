...
function makeCfg(overrides: Partial<TrinityConfig> = {}): TrinityConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): TrinityConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): TrinityConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
