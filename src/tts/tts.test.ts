...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.Trinity_TTS_PREFS;
      process.env.Trinity_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.Trinity_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: TrinityConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
