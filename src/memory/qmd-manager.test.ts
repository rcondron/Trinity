...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: TrinityConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: TrinityConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__TrinityMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__TrinityMcporterColdStartWarned;
  });
