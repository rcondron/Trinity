...
function resolveGatewayPort(cfg: TrinityConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: TrinityConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.Trinity_GATEWAY_PASSWORD?.trim() ||
