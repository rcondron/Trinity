...
function mergeIMessageAccountConfig(cfg: TrinityConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: TrinityConfig): ResolvedIMessageAccount[] {
