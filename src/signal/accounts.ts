...
function mergeSignalAccountConfig(cfg: TrinityConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: TrinityConfig): ResolvedSignalAccount[] {
