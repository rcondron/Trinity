...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@Trinity", { botUsername: "Trinity" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@Trinity args", {
        botUsername: "Trinity",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "Trinity" })).toBe(
      "/help@otherbot",
    );
  });
