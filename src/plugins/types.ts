...
export type TrinityPluginConfigSchema = {
...
export type TrinityPluginToolContext = {
...
export type TrinityPluginToolFactory = (
  ctx: TrinityPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type TrinityPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type TrinityPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<TrinityConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type TrinityPluginGatewayMethod = {
  method: string;
 ...
 */
export type TrinityPluginCommandDefinition = {
...
export type TrinityPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type TrinityPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type TrinityPluginCliContext = {
  program: Command;
  config: TrinityConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type TrinityPluginCliRegistrar = (ctx: TrinityPluginCliContext) => void | Promise<void>;

export type TrinityPluginServiceContext = {
  config: TrinityConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type TrinityPluginService = {
  id: string;
  start: (ctx: TrinityPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: TrinityPluginServiceContext) => void | Promise<void>;
};

export type TrinityPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type TrinityPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: TrinityPluginConfigSchema;
  register?: (api: TrinityPluginApi) => void | Promise<void>;
  activate?: (api: TrinityPluginApi) => void | Promise<void>;
};

export type TrinityPluginModule =
  | TrinityPluginDefinition
  | ((api: TrinityPluginApi) => void | Promise<void>);

export type TrinityPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | TrinityPluginToolFactory,
    opts?: TrinityPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: TrinityPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: TrinityPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: TrinityPluginHttpRouteHandler }) => void;
  registerChannel: (registration: TrinityPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: TrinityPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: TrinityPluginService) => void;
   ...
   */
  registerCommand: (command: TrinityPluginCommandDefinition) => void;
