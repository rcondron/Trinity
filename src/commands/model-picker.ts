...
type PromptDefaultModelResult = { model?: string; config?: TrinityConfig };
...
function resolveConfiguredModelRaw(cfg: TrinityConfig): string {
...
function resolveConfiguredModelKeys(cfg: TrinityConfig): string[] {
...
export function applyPrimaryModel(cfg: TrinityConfig, model: string): TrinityConfig {
...
export function applyModelAllowlist(cfg: TrinityConfig, models: string[]): TrinityConfig {
  const defaults = cfg.agents?.defaults;
