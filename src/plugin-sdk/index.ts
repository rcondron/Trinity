...
export type { TrinityConfig } from "../config/config.js";
/** @deprecated Use TrinityConfig instead */
export type { TrinityConfig as ClawdbotConfig } from "../config/config.js";
