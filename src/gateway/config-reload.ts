...
import type { TrinityConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: TrinityConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: TrinityConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: TrinityConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: TrinityConfig) => void;
  log: {
