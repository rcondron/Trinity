...
import { type TrinityConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: TrinityConfig): string[] {
...
export function listAgentsForGateway(cfg: TrinityConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: TrinityConfig): string {
...
function resolveSessionStoreAgentId(cfg: TrinityConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: TrinityConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: TrinityConfig): GatewaySessionsDefaults {
