...
This directory contains the **BlueBubbles external channel plugin** for Trinity.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `Trinity/plugin-sdk` helpers.
