...
import { resolveChannelMediaMaxBytes, type TrinityConfig } from "Trinity/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: TrinityConfig; accountId?: string }): string[] {
