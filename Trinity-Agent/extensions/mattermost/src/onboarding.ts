import type { ChannelOnboardingAdapter, TrinityConfig, WizardPrompter } from "Trinity/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.Trinity.ai/channels/mattermost",
    ].join("\n"),
