...
Nostr DM channel plugin for Trinity using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Trinity. It enables your bot to:
...
```bash
Trinity plugins install @Trinity/nostr
```
...
# Configure Trinity to use local relay
