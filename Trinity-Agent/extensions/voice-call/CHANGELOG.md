...
- Version alignment with core Trinity release numbers.
...
- First public release of the @Trinity/voice-call plugin.
...
- CLI: `Trinity voicecall` commands (call/start/continue/speak/end/status/tail/expose).
