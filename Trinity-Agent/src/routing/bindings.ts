...
export function listBindings(cfg: TrinityConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: TrinityConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: TrinityConfig) {
