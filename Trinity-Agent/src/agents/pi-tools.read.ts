...
function resolveAdaptiveReadMaxBytes(options?: TrinityReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createTrinityReadTool(base, {
...
export function createTrinityReadTool(
  base: AnyAgentTool,
  options?: TrinityReadToolOptions,
): AnyAgentTool {
