...
export function resolveSessionToolsVisibility(cfg: TrinityConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: TrinityConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: TrinityConfig): AgentToAgentPolicy {
