...
function resolveMemoryToolContext(options: { config?: TrinityConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: TrinityConfig): MemoryCitationsMode {
