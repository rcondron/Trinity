...
function resolveAvatarSource(cfg: TrinityConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: TrinityConfig, agentId: string): AgentAvatarResolution {
