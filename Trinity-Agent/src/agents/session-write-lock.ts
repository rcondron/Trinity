...
const CLEANUP_STATE_KEY = Symbol.for("Trinity.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("Trinity.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("Trinity.sessionWriteLockWatchdogState");
