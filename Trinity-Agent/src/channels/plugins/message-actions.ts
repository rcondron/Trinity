...
export function listChannelMessageActions(cfg: TrinityConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: TrinityConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: TrinityConfig): boolean {
  for (const plugin of listChannelPlugins()) {
