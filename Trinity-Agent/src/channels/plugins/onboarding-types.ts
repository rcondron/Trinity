...
export type PromptAccountIdParams = {
  ...
  label: string;
  currentId?: string;
  listAccountIds: (cfg: TrinityConfig) => string[];
...
export type ChannelOnboardingDmPolicy = {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: TrinityConfig) => DmPolicy;
  setPolicy: (cfg: TrinityConfig, policy: DmPolicy) => TrinityConfig;
...
export type ChannelOnboardingAdapter = {
  ...
  disable?: (cfg: TrinityConfig) => TrinityConfig;
};
