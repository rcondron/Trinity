...
import { discoverTrinityPlugins } from "../../plugins/discovery.js";
import type { TrinityPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, TrinityPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["Trinity_PLUGIN_CATALOG_PATHS", "Trinity_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<TrinityPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: TrinityPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: TrinityPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverTrinityPlugins({ workspaceDir: options.workspaceDir });
