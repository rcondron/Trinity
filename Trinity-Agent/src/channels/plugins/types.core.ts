...
export type ChannelAgentToolFactory = (params: { cfg?: TrinityConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: TrinityConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: TrinityConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: TrinityConfig }) => boolean;
  supportsCards?: (params: { cfg: TrinityConfig }) => boolean;
