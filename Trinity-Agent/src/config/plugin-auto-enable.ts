...
function isTelegramConfigured(cfg: TrinityConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: TrinityConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: TrinityConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: TrinityConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: TrinityConfig): boolean {
...
function isIMessageConfigured(cfg: TrinityConfig): boolean {
...
function isWhatsAppConfigured(cfg: TrinityConfig): boolean {
...
function isGenericChannelConfigured(cfg: TrinityConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: TrinityConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: TrinityConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: TrinityConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: TrinityConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: TrinityConfig, pluginId: string): TrinityConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
