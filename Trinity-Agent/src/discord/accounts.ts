...
function mergeDiscordAccountConfig(cfg: TrinityConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: TrinityConfig): ResolvedDiscordAccount[] {
