...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.Trinity_STATE_DIR;
  const configPath = env.Trinity_CONFIG_PATH;
  ...
  return {
    ...
    Trinity_GATEWAY_PORT: String(port),
    Trinity_GATEWAY_TOKEN: token,
    Trinity_LAUNCHD_LABEL: resolvedLaunchdLabel,
    Trinity_SYSTEMD_UNIT: systemdUnit,
    Trinity_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    Trinity_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    Trinity_SERVICE_VERSION: VERSION,
  };
}
