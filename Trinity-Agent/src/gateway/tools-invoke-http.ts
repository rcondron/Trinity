...
import { createTrinityTools } from "../agents/Trinity-tools.js";
import {
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(
    getHeader(req, "x-Trinity-message-channel") ?? "",
  );
  const accountId = getHeader(req, "x-Trinity-account-id")?.trim() || undefined;
  ...
  const allTools = createTrinityTools({
