...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @Trinity/voice-call -> voice-call).
...
export function discoverTrinityPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".Trinity", "extensions")];
