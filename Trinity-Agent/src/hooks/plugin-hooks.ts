...
import type { TrinityPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: TrinityPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: TrinityPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
