...
export function applyVercelAiGatewayProviderConfig(cfg: TrinityConfig): TrinityConfig {
...
export function applyVercelAiGatewayConfig(cfg: TrinityConfig): TrinityConfig {
