...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Trinity status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("Trinity security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("Trinity security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.Trinity.ai/faq");
  runtime.log("Troubleshooting: https://docs.Trinity.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("Trinity status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("Trinity logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("Trinity status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("Trinity gateway probe")}`);
  }
}
