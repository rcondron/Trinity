...
function resolveDefaultAccountId(cfg: TrinityConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: TrinityConfig): boolean {
...
export function summarizeBindings(cfg: TrinityConfig, bindings: AgentBinding[]): string[] {
