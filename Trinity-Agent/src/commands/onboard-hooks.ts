...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.Trinity.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("Trinity hooks list")}`,
      `  ${formatCliCommand("Trinity hooks enable <name>")}`,
      `  ${formatCliCommand("Trinity hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
