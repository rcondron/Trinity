    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["Trinity directory self --channel slack", "Show the connected account identity."],
          [
            'Trinity directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["Trinity directory groups list --channel discord", "List available groups/channels."],
          [
            "Trinity directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.Trinity.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
