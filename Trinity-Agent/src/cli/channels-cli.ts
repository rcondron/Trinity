    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["Trinity channels list", "List configured channels and auth profiles."],
          ["Trinity channels status --probe", "Run channel status checks and probes."],
          [
            "Trinity channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["Trinity channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.Trinity.ai/cli/channels",
        )}\n`,
    );
