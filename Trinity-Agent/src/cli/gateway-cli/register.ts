      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["Trinity gateway run", "Run the gateway in the foreground."],
            ["Trinity gateway status", "Show service status and probe reachability."],
            ["Trinity gateway discover", "Find local and wide-area gateway beacons."],
            ["Trinity gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.Trinity.ai/cli/gateway")}\n`,
      ),
  );
