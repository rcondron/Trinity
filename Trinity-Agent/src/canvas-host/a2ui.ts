...
export const A2UI_PATH = "/__Trinity__/a2ui";

export const CANVAS_HOST_PATH = "/__Trinity__/canvas";

export const CANVAS_WS_PATH = "/__Trinity__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.TrinityCanvasA2UIAction.postMessage(...)
  // - Android: window.TrinityCanvasA2UIAction.postMessage(...)
  const handlerNames = ["TrinityCanvasA2UIAction"];
  ...
  globalThis.Trinity = globalThis.Trinity ?? {};
  globalThis.Trinity.postMessage = postToNode;
  globalThis.Trinity.sendUserAction = sendUserAction;
  globalThis.TrinityPostMessage = postToNode;
  globalThis.TrinitySendUserAction = sendUserAction;
