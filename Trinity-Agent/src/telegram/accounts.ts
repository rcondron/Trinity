...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.Trinity_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: TrinityConfig): string[] {
...
export function listTelegramAccountIds(cfg: TrinityConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: TrinityConfig): string {
...
function mergeTelegramAccountConfig(cfg: TrinityConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: TrinityConfig): ResolvedTelegramAccount[] {
