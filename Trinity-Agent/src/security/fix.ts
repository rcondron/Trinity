...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof TrinityConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: TrinityConfig; env: NodeJS.ProcessEnv }): {
  cfg: TrinityConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
