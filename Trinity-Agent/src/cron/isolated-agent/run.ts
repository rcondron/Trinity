...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/Trinity/Trinity/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.Trinity_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.Trinity/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: TrinityConfig = {
    ...params.cfg,
