...
export function listWhatsAppAuthDirs(cfg: TrinityConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: TrinityConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: TrinityConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: TrinityConfig): ResolvedWhatsAppAccount[] {
