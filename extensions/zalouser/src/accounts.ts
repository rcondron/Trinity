...
export function listZalouserAccountIds(cfg: TrinityConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: TrinityConfig): string {
...
function mergeZalouserAccountConfig(cfg: TrinityConfig, accountId: string): ZalouserAccountConfig {
