...
export function listBlueBubblesAccountIds(cfg: TrinityConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: TrinityConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: TrinityConfig): ResolvedBlueBubblesAccount[] {
