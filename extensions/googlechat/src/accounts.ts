...
export function listGoogleChatAccountIds(cfg: TrinityConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: TrinityConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: TrinityConfig): ResolvedGoogleChatAccount[] {
