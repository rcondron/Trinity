...
import type { ReplyPayload, TrinityConfig } from "Trinity/plugin-sdk";
import { createReplyPrefixOptions } from "Trinity/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as TrinityConfig;
