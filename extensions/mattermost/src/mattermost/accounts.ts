...
export function listMattermostAccountIds(cfg: TrinityConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: TrinityConfig): string {
...
export function listEnabledMattermostAccounts(cfg: TrinityConfig): ResolvedMattermostAccount[] {
