...
export { createDedupeCache, rawDataToString } from "Trinity/plugin-sdk";
...
function listAgents(cfg: TrinityConfig): AgentEntry[] {
...
export function resolveIdentityName(cfg: TrinityConfig, agentId: string): string | undefined {
